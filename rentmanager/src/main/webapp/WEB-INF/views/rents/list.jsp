                    ...
                    <div class="box">
                        <div class="box-body no-padding">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td>${rent.id}</td>
                                    <td>${rent.vehicle_id.constructor} ${rent.vehicle_id.model}</td>
                                    <td>${rent.client_id.firstName} ${rent.client_id.lastName}</td>
                                    <td>${rent.debut}</td>
                                    <td>${rent.fin}</td>
                                    <td>
                                        ...
                                        <a class="btn btn-success" href="${pageContext.request.contextPath}/rents/editRent?id=${rent.id}">
